...
func wireApp(confServer *conf.Server, confData *conf.Data, volcengine *conf.Volcengine, company *conf.Company, confService *conf.Service, registry *conf.Registry, event *conf.Event, logger log.Logger) (*kratos.App, func(), error) {
	...
	doukeProductShareRepo := data.NewDoukeProductShareRepo(dataData, logger)
	companyProductUsecase := biz.NewCompanyProductUsecase(companyProductRepo, companyProductCategoryRepo, companyMaterialLibraryRepo, companyRepo, companySetRepo, openDouyinUserInfoRepo, jinritemaiStoreRepo, jinritemaiOrderRepo, weixinUserScanRecordRepo, materialMaterialRepo, doukeProductShareRepo, transaction, confData, company, volcengine, event, logger)
	...
	companyTaskAccountRelationUsecase := biz.NewCompanyTaskAccountRelationUsecase(companyTaskRepo, companyTaskDetailRepo, companyProductRepo, companyTaskAccountRelationRepo, transaction, confData, volcengine, logger)
	companyTaskDetailUsecase := biz.NewCompanyTaskDetailUsecase(companyTaskDetailRepo, confData, logger)
