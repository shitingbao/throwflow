...
func (cs *CompanyService) GetCompanyOrganizations(ctx context.Context, in *v1.GetCompanyOrganizationsRequest) (*v1.GetCompanyOrganizationsReply, error) {
	...
	organizationColonelCommission := &v1.GetCompanyOrganizationsReply_OrganizationColonelCommission{
		...
		ZeroAdvancedPresenterZeroCourseCommissionRule:         tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.ZeroAdvancedPresenterZeroCourseCommissionRule), 2),
		ZeroAdvancedTutorZeroCourseCommissionRule:             tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.ZeroAdvancedTutorZeroCourseCommissionRule), 2),
		...
		PrimaryCourseRatio: tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryCourseRatio), 2),
		PrimaryAdvancedPresenterPrimaryCourseCommissionRule:           tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryAdvancedPresenterPrimaryCourseCommissionRule), 2),
		PrimaryAdvancedTutorPrimaryCourseCommissionRule:               tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryAdvancedTutorPrimaryCourseCommissionRule), 2),
		IntermediateAdvancedPresenterPrimaryCourseCommissionRule:      tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.IntermediateAdvancedPresenterPrimaryCourseCommissionRule), 2),
		IntermediateAdvancedTutorPrimaryCourseCommissionRule:          tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.IntermediateAdvancedTutorPrimaryCourseCommissionRule), 2),
		AdvancedPresenterPrimaryCourseCommissionRule:                  tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.AdvancedPresenterPrimaryCourseCommissionRule), 2),
		IntermediateCourseRatio:                                       tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.IntermediateCourseRatio), 2),
		PrimaryAdvancedPresenterIntermediateCourseCommissionRule:      tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryAdvancedPresenterIntermediateCourseCommissionRule), 2),
		PrimaryAdvancedTutorIntermediateCourseCommissionRule:          tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryAdvancedTutorIntermediateCourseCommissionRule), 2),
		IntermediateAdvancedPresenterIntermediateCourseCommissionRule: tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.IntermediateAdvancedPresenterIntermediateCourseCommissionRule), 2),
		IntermediateAdvancedTutorIntermediateCourseCommissionRule:     tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.IntermediateAdvancedTutorIntermediateCourseCommissionRule), 2),
		AdvancedPresenterIntermediateCourseCommissionRule:             tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.AdvancedPresenterIntermediateCourseCommissionRule), 2),
		AdvancedCourseRatio: tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.AdvancedCourseRatio), 2),
		PrimaryAdvancedPresenterAdvancedCourseCommissionRule:      tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryAdvancedPresenterAdvancedCourseCommissionRule), 2),
		PrimaryAdvancedTutorAdvancedCourseCommissionRule:          tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryAdvancedTutorAdvancedCourseCommissionRule), 2),
		IntermediateAdvancedPresenterAdvancedCourseCommissionRule: tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.IntermediateAdvancedPresenterAdvancedCourseCommissionRule), 2),
		IntermediateAdvancedTutorAdvancedCourseCommissionRule:     tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.IntermediateAdvancedTutorAdvancedCourseCommissionRule), 2),
		AdvancedPresenterAdvancedCourseCommissionRule:             tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.AdvancedPresenterAdvancedCourseCommissionRule), 2),
		OrderRatio: tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.OrderRatio), 2),
		PrimaryAdvancedPresenterOrderCommissionRule:          tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryAdvancedPresenterOrderCommissionRule), 2),
		PrimaryAdvancedTutorOrderCommissionRule:              tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.PrimaryAdvancedTutorOrderCommissionRule), 2),
		...
		ZeroAdvancedPresenterCostOrderCommissionRule:         tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.ZeroAdvancedPresenterCostOrderCommissionRule), 2),
		ZeroAdvancedTutorCostOrderCommissionRule:             tool.Decimal(float64(companyOrganization.OrganizationColonelCommissions.ZeroAdvancedTutorCostOrderCommissionRule), 2),
