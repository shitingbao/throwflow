...
func (is *InterfaceService) ListCompanyOrganizations(ctx context.Context, in *v1.ListCompanyOrganizationsRequest) (*v1.ListCompanyOrganizationsReply, error) {
	...
	for _, companyOrganization := range companyOrganizations.Data.List {
		...
		organizationColonelCommission := &v1.ListCompanyOrganizationsReply_OrganizationColonelCommission{
			...
			CourseRatio: companyOrganization.OrganizationColonelCommission.CourseRatio,
			PrimaryAdvancedPresenterCourseCommissionRule:         companyOrganization.OrganizationColonelCommission.PrimaryAdvancedPresenterCourseCommissionRule,
			PrimaryAdvancedTutorCourseCommissionRule:             companyOrganization.OrganizationColonelCommission.PrimaryAdvancedTutorCourseCommissionRule,
			IntermediateAdvancedPresenterCourseCommissionRule:    companyOrganization.OrganizationColonelCommission.IntermediateAdvancedPresenterCourseCommissionRule,
			IntermediateAdvancedTutorCourseCommissionRule:        companyOrganization.OrganizationColonelCommission.IntermediateAdvancedTutorCourseCommissionRule,
			AdvancedPresenterCourseCommissionRule:                companyOrganization.OrganizationColonelCommission.AdvancedPresenterCourseCommissionRule,
...
func (is *InterfaceService) CreateCompanyOrganizations(ctx context.Context, in *v1.CreateCompanyOrganizationsRequest) (*v1.CreateCompanyOrganizationsReply, error) {
	...
	organizationColonelCommission := &v1.CreateCompanyOrganizationsReply_OrganizationColonelCommission{
		...
		CourseRatio: companyOrganization.Data.OrganizationColonelCommission.CourseRatio,
		PrimaryAdvancedPresenterCourseCommissionRule:         companyOrganization.Data.OrganizationColonelCommission.PrimaryAdvancedPresenterCourseCommissionRule,
		PrimaryAdvancedTutorCourseCommissionRule:             companyOrganization.Data.OrganizationColonelCommission.PrimaryAdvancedTutorCourseCommissionRule,
		IntermediateAdvancedPresenterCourseCommissionRule:    companyOrganization.Data.OrganizationColonelCommission.IntermediateAdvancedPresenterCourseCommissionRule,
		IntermediateAdvancedTutorCourseCommissionRule:        companyOrganization.Data.OrganizationColonelCommission.IntermediateAdvancedTutorCourseCommissionRule,
		AdvancedPresenterCourseCommissionRule:                companyOrganization.Data.OrganizationColonelCommission.AdvancedPresenterCourseCommissionRule,
